...
const faqs = [
  { q: 'Обучение бесплатное?', a: 'Да! Все программы ДЮЦ «Лидер» для детей и подростков до 18 лет финансируются из бюджета Архангельской области и предоставляются полностью бесплатно.' },
